...
# --- Constantes ---
INPUT_PICKLE_PATH = '/home/hp/market_basket_analysis/prepared_transactions_basket.pkl'

def main():
    """Carrega as transações do dataset Basket, executa a análise e exibe os resultados."""
    ...
    try:
        ...
        print("Por favor, execute o script 'data_preparation_basket.py' primeiro.")
        return
    ...
    print("Gerando regras de associação a partir dos itemsets (min_confidence=0.1)...")
    ...
    if not rules.empty:
        ...
        print("\n--- Top 20 Regras de Associação Mais Fortes (Dataset Basket) ---")
